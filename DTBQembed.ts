...
var ChannelNamesAndLinks = Array(
  ...
  "TVAArhus,https://d1pdqnzctoj5f8.cloudfront.net/clients_live/tv3/vr-hd1/chunklist.m3u8"
);
//#endregion
...
Tellyform.addEventListener("submit", function(event:any) {
  ...
  let Videoplayer = document.getElementById("my_video_1") as HTMLVideoElement;
  let VideoSource = document.getElementById("my_video_1_id") as HTMLEmbedElement;

  // video player and source should be editable here later

  let VideoJs = document.createElement("script") as any;
