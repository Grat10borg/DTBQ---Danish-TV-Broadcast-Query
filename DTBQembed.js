...
Tellyform.addEventListener("submit", function (event) {
    ...
    let Videoplayer = document.getElementById("my_video_1");
    let VideoSource = document.getElementById("my_video_1_id");
    let VideoJs = document.createElement("script");
    let scriptsdiv = document.getElementById("scripts");
    VideoSource.src = TVLinks[TVChannels.indexOf(ChannelName.value)];
    Videoplayer.hidden = false;
    VideoJs.src = "https://unpkg.com/video.js/dist/video.js";
    scriptsdiv.append(VideoJs);
});
